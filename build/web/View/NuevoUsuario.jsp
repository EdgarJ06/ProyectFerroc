...
<html>
    <head>
        ...
        <title>Sistema Ferrocon| Inicio</title>
        ...
        <div class="wrapper">
            ...
            <header class="main-header">
                <a href="#" class="logo">
                    ...
                    <span class="logo-mini"><b>S</b>FR</span>
                    <!-- logo for regular state and mobile devices -->
                    <span class="logo-lg"><b>Sistema </b>Ferrocon</span>
                </a>
                        ...
                        <ul class="nav navbar-nav">
                            ...
                            <li class="dropdown user user-menu">
                                ...
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                    ...
                                    <img src="dist/img/hombre.png" class="user-image" alt="User Image">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li class="user-header">
                                        <img src="dist/img/hombre.png" class="img-circle" alt="User Image">
                    ...
                    <div class="box">
                        ...
                        <form class="form-horizontal" action="srvUsuario?accion=registrar" method="post">
                                        ...
                                        <select class="form-control"  name="cboCargo" autofocus=""  required="">
                                            ...
                                            <c:forEach items="${cargos}" var="car">
                                                <option value="${car.id_cargo}"  
                                                        <c:if test="${car.id_cargo == Usuario.cargo.id_cargo}">
                                                              selected
                                                        </c:if> >
                                                        ${car.nombreCargo}
                                                </option>
                            ...
                            <div class="box-footer">
                                ...
                                <button type="submit" id="" name="btnRegistrar" value="btnRegistrar" class="btn btn-success"><i class="fa fa-floppy-o"></i> Registrar</button>
